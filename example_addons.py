...
def main():
    ...
    working_memory = DecayWorkingMemory(latent_dim=128, decay_rate=0.7, blend_weight=0.6)
    ...
    for step in range(1, 4):
        ...
        print(f"  [Ignition Gating] Gated workspace ignition status:\n    {overall_ignition.squeeze(-1)}")
        ...
        print(f"  [Working Memory] Blended workspace memory trace shape: {blended_workspace.shape}")

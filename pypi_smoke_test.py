"""
Smoke test: verifies cognitive-aug 0.2.0 installs and imports correctly from PyPI.
Run this inside a fresh venv AFTER: pip install cognitive-aug==0.2.0
"""
import sys
...
print("\n========================================")
print("  ALL TESTS PASSED — cognitive-aug 0.2.0")
print("========================================")
